...
local ESP; ESP = {
    Settings = {
        ...
        Line = {Enabled = false, Color = Color3.fromRGB(255, 255, 255), Transparency = 0},
        Line_Outline = {Enabled = false, Color = Color3.fromRGB(0, 0, 0), Transparency = 0, Outline_Size = 1},
...
do -- // Player Metatable \\ --
    ...
    function Player_Metatable:Update()
        ...
        local Line = self.Components.Line
        local Chams = _G.chamsEnabled == true and self.Components.Chams or true
        if Box == nil or BoxFill == nil or Box_Outline == nil or Healthbar == nil or Healthbar_Outline == nil or Name == nil or NameBold == nil or Distance == nil or DistanceBold == nil or Tool == nil or ToolBold == nil or Health == nil or HealthBold == nil or Line == nil or Line_Outline == nil or Chams == nil then
            self:Destroy()
        end
        ...
        if Character ~= nil then
            ...
            if Head and HumanoidRootPart and Current_Health > 0 then
                ...
                if ESP.Settings.Enabled and On_Screen and Meter_Distance < ESP.Settings.Maximal_Distance and Good then
                    ...
                    local Line_Settings = ESP.Settings.Line
                    Line.From = Vector2.new(Camera.ViewportSize.X / 2, Camera.ViewportSize.Y / 1)
                    Line.To = Box_Position
                    Line.Color = Line_Settings.Color
                    Line.Transparency = Framework:Drawing_Transparency(Line_Settings.Transparency)
                    Line.Visible = Line_Settings.Enabled

                    local Line_Outline_Settings = ESP.Settings.Line_Outline
                    Line_Outline.From = Line.From
                    Line_Outline.To = Line.To
                    Line_Outline.Color = Line_Outline_Settings.Color
                    Line_Outline.Thickness = Line_Outline_Settings.Outline_Size + 2
                    Line_Outline.Transparency = Framework:Drawing_Transparency(Line_Outline_Settings.Transparency)
                    Line_Outline.Visible = Line_Settings.Enabled and Line_Outline_Settings.Enabled or false
