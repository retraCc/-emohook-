-- yes this is linoria, im too lazy to make my own ui lib so im just gonna update this
...
local Library = {
    ...
    AccentColor = Color3.fromRGB(86, 52, 140);
...
do
    ...
    function Funcs:AddToggle(Idx, Info)
        ...
        local ToggleGradient = Library:Create('UIGradient', {
            Color = ColorSequence.new({
                ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 240, 102)),
                ColorSequenceKeypoint.new(1, Color3.fromRGB(256, 241, 103))
            });
            Rotation = 90;
            Parent = ToggleInner;
        });
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        function Slider:Display()
            ...
            DisplayLabel.Text = Slider.Value .. Suffix .. Slider.Max;
        elseif not Info.Compact then
...
do
    ...
    local WatermarkOuter = Library:Create('Frame', {
        BorderColor3 = Color3.new(0, 0, 0);
        Position = UDim2.new(0, 762.5, 0, -25);
